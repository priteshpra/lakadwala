...
$id = $_GET['id'];
$catname = ($_GET['catname'])?$_GET['catname']:'';
$sub_category_name=($_GET['sub_cat_name'])?$_GET['sub_cat_name']:'';
$pro=($_GET['productname'])?$_GET['productname']:'';
...
$res2 = mysqli_query($conn, "SELECT * FROM `sub_product` WHERE sub_product_id=$id and flag=1") or die("Query Unsuccessful.");
        ...
        <div class="col-md-12">
            <div class="row d-flex justify-content-between">
                <h6 class="text-muted ml-2">
                    <?php echo ($catname)?$catname.' &nbsp;>&nbsp;':""; ?><?php echo  ($sub_category_name)?$sub_category_name.'&nbsp;>&nbsp;':"" ?> <?php echo ($pro)?$pro.' &nbsp;>&nbsp;':"" ?>
                    <?php echo $sub  ?></h6>
                ...
                <div class="col-md-12">
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <img src="sub_product/<?php print_r($headers1[0]); ?>" class="rounded img-thumbnail mr-2"
                            style="width:40px;"><?php echo $sub ?> is added to cart. <a href="cart1.php"
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                function my_function() {
                    ...
                    request.open("GET", "lastcat.php", true);
                    request.send();
                }
                </script>
                <div class="col-md-6 mt-3" style="background-color:#f5f5f5;">
                            ...
                            <div class='col-md-12 '>
                                ...
                                <div class='col-md-8'>
                                    <form action='cart.php' method='post'>
                                        ...
                                        <button type='submit' name='Submit1' value='Submit1' class='btn btn-success w-100' onclick='my_function()'>Add To Cart</button>
                                    </form>
                                </div>
                                </div>
                                </div>
