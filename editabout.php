...
$id = $_GET['id'];
$res = mysqli_query($conn, "SELECT * FROM `aboutus`") or die("Query Unsuccessful.");
?>
<!DOCTYPE html>
<html lang="en">
<?php
            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row mx-1 d-flex justify-content-between">
                        <h2 class='text-center mb-3'>Edit About Us</h2>
                ...
                <div class="row justify-content-center">
                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                        action="edit.php?id=<?php echo $row['id']?>&image=<?php echo $image23?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-10 col-lg-6 ">
                                    <label for="inputEmail3" class="col-form-label">About Us Oneliner</label>
                                    <div class="form-group border border-success" style="background-color:white;">
                                        <input type="text" id="c_name" class="form-control text-dark"
                                            style="background-color:white;" name="one_line" required
                                            value="<?php echo $row['about one line']?>">
                                    </div>
                                </div>
                                <div class="col-sm-5 col-lg-3">
                                    <label for="inputEmail3" class="col-form-label text-dark">About Image</label>
                                    <div class="form-group border border-success" style="background-color:white;">
                                        <input class="form-control text-dark pb-3" id="image" type="file" name="image"
                                            style="background-color:white;" value="" placeholder="">
                                    </div>
                                </div>
                                <div class="col-sm-5 col-lg-3 my-auto form-group">
                                    <img src="logo/<?php echo $image23; ?>" alt="" style="width:80px">
                                </div>
                                <div class="col-sm-12 col-lg-12 ">
                                    <label for="inputEmail3" class="col-form-label text-dark">About Us Content</label>
                                    <div class="form-group border border-success" style="background-color:white;">
                                        <textarea name="description" id="short_description"
                                            class="materialize-textarea"><?php echo $row['content']?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center card-body">
                            <button type="submit" class="btn btn-success" name="edit_about">SUBMIT</button>
