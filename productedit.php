            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                        action="edit.php?id=<?php echo $id?>&image=<?php echo $image23?>">
                         <HR class='bg-success'>
                        </HR>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12">
                                    <label for="inputEmail3" class="col-form-label text-dark">Product Name</label>
                                ...
                                <div class="col-sm-2 col-lg-2 my-auto form-group ">
                                    <img src="products/<?php echo $image23; ?>" alt="" style="width:80px"
                                        class="border">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center card-body">
                            <button type="submit" class="btn btn-success" name="edit_product">SUBMIT</button>
                        </div>
                    </form>
                    <?php
                    }
